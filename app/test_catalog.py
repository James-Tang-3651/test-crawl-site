...
TEST_SECTIONS: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "entries": [
            ...
            {
                "path": "/images/with-extension",
                "crawl_worthy": True,
                "category": "images_with_extension_page",
                "label": "Images with extension subpage",
                "home_links": [{"href": "/images/with-extension", "label": "Images with extension"}],
            },
            {
                "path": "/images/no-extension",
                "crawl_worthy": True,
                "category": "images_no_extension_page",
                "label": "Images without extension subpage",
                "home_links": [{"href": "/images/no-extension", "label": "Images without extension"}],
            },
            {"category": "image_asset", "include_in_manifest": False, "label": "Image file"},
            {"category": "image_png_asset", "include_in_manifest": False, "label": "PNG image file"},
            {"category": "image_gif_asset", "include_in_manifest": False, "label": "GIF image file"},
            {"category": "image_webp_asset", "include_in_manifest": False, "label": "WebP image file"},
            {"category": "image_svg_asset", "include_in_manifest": False, "label": "SVG image file"},
            {"category": "image_jpeg_no_ext_asset", "include_in_manifest": False, "label": "JPEG image (no URL extension)"},
            {"category": "image_png_no_ext_asset", "include_in_manifest": False, "label": "PNG image (no URL extension)"},
            {"category": "image_gif_no_ext_asset", "include_in_manifest": False, "label": "GIF image (no URL extension)"},
            {"category": "image_webp_no_ext_asset", "include_in_manifest": False, "label": "WebP image (no URL extension)"},
            {"category": "image_svg_no_ext_asset", "include_in_manifest": False, "label": "SVG image (no URL extension)"},
            {
                "category": "zip_asset",
                "include_in_manifest": False,
                "label": "ZIP file",
