    ...
    },
    {
        ...
        "entries": [
            ...
            },
            {
                ...
                "include_in_manifest": False,
                "label": "JPEG image (with extension)",
                "home_links": [{"href": "/images-with-extension/pixel.jpg", "label": "JPEG image (with extension)"}],
            },
            {
                "category": "image_png_asset",
                "include_in_manifest": False,
                "label": "PNG image (with extension)",
                "home_links": [{"href": "/images-with-extension/png-example.png", "label": "PNG image (with extension)"}],
            },
            {
                "category": "image_gif_asset",
                "include_in_manifest": False,
                "label": "GIF image (with extension)",
                "home_links": [{"href": "/images-with-extension/gif-example.gif", "label": "GIF image (with extension)"}],
            },
            {
                "category": "image_webp_asset",
                "include_in_manifest": False,
                "label": "WebP image (with extension)",
                "home_links": [{"href": "/images-with-extension/webpfile.webp", "label": "WebP image (with extension)"}],
            },
            {
                "category": "image_svg_asset",
                "include_in_manifest": False,
                "label": "SVG image (with extension)",
                "home_links": [{"href": "/images-with-extension/svg-example.svg", "label": "SVG image (with extension)"}],
            },
            {
                "category": "image_jpeg_no_ext_asset",
                "include_in_manifest": False,
                "label": "JPEG image (no URL extension)",
                "home_links": [{"href": "/images-without-extension/jpeg-image", "label": "JPEG image (no URL extension)"}],
            },
            {
                "category": "image_png_no_ext_asset",
                "include_in_manifest": False,
                "label": "PNG image (no URL extension)",
                "home_links": [{"href": "/images-without-extension/png-image", "label": "PNG image (no URL extension)"}],
            },
            {
                "category": "image_gif_no_ext_asset",
                "include_in_manifest": False,
                "label": "GIF image (no URL extension)",
                "home_links": [{"href": "/images-without-extension/gif-image", "label": "GIF image (no URL extension)"}],
            },
            {
                "category": "image_webp_no_ext_asset",
                "include_in_manifest": False,
                "label": "WebP image (no URL extension)",
                "home_links": [{"href": "/images-without-extension/webp-image", "label": "WebP image (no URL extension)"}],
            },
            {
                "category": "image_svg_no_ext_asset",
                "include_in_manifest": False,
                "label": "SVG image (no URL extension)",
                "home_links": [{"href": "/images-without-extension/svg-image", "label": "SVG image (no URL extension)"}],
            },
            {
                "category": "zip_asset",
                "include_in_manifest": False,
