...
EXTRA_PATHS = [
    ...
    *SITEMAP_PATHS,
    ...
    "/images-with-extension/pixel.jpg",
    "/images-with-extension/png-example.png",
    "/images-with-extension/gif-example.gif",
    "/images-with-extension/webpfile.webp",
    "/images-with-extension/svg-example.svg",
    "/images-without-extension/jpeg-image",
    "/images-without-extension/png-image",
    "/images-without-extension/gif-image",
    "/images-without-extension/webp-image",
    "/images-without-extension/svg-image",
    "/download/sample.zip",
    "/editable",
